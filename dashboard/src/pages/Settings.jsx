...
import { Save, Server, Shield, GitBranch, User, Eye, EyeOff, CheckCircle, Trash2, Plus, Globe, Code, Box, Loader2, X } from 'lucide-react';
    ...
    return (
        <div className="max-w-2xl space-y-5">
            ...
            <div className="glass-card p-5">
                <h3 className="text-[13px] font-semibold text-slate-700 dark:text-slate-300 mb-3">System Information</h3>
                <div className="grid grid-cols-2 gap-3 text-[12px]">
                    {[
                        ...
                        <div key={i.label}>
                            <div className="text-[10px] font-semibold uppercase tracking-wide text-slate-400 mb-0.5">{i.label}</div>
                            <div className="text-slate-700 dark:text-slate-300">{i.value}</div>
                        </div>
                    ))}
                </div>
            </div>
